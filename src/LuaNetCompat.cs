...
public enum LuaGC
{
    ...
    /// </summary>
    Stop = NativeMethods.LUA_GCSTOP,
    /// <summary>
    /// Restarts the garbage collector. 
    /// </summary>
    Restart = NativeMethods.LUA_GCRESTART,
    /// <summary>
    /// Performs a full garbage-collection cycle. 
    /// </summary>
    Collect = NativeMethods.LUA_GCCOLLECT,
    /// <summary>
    ///  Returns the current amount of memory (in Kbytes) in use by Lua. 
    /// </summary>
    Count = NativeMethods.LUA_GCCOUNT,
    /// <summary>
    ///  Returns the remainder of dividing the current amount of bytes of memory in use by Lua by 1024
    /// </summary>
    Countb = NativeMethods.LUA_GCCOUNTB,
    /// <summary>
    ///  Performs an incremental step of garbage collection. 
    /// </summary>
    Step = NativeMethods.LUA_GCSTEP,
    /// <summary>
    ...
    /// </summary>
    SetPause = NativeMethods.LUA_GCSETPAUSE,
    /// <summary>
    /// The options LUA_GCSETPAUSE and LUA_GCSETSTEPMUL of the function lua_gc are deprecated. You should use the new option LUA_GCINC to set them. 
    /// </summary>
    SetStepMultiplier = NativeMethods.LUA_GCSETSTEPMUL,
    /// <summary>
